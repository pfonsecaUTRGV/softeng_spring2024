...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference("Datum.count") do
      post data_url, params: { datum: { email: @datum.email, first_name: @datum.first_name, last_name: @datum.last_name, phone: @datum.phone } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { email: @datum.email, first_name: @datum.first_name, last_name: @datum.last_name, phone: @datum.phone } }
